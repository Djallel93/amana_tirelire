function recupTirelir(e) {
  ...
  if ((editedColumn == tirelireColumns.recupere && e.value.toLowerCase() === 'true')
    ...
    if (sheet.getRange(editedRow, tirelireColumns.date_retrait).getValue() == '') {
      ...
      noRollbackSetValue(sheet.getRange(editedRow, tirelireColumns.date_retrait), currentDate);
      ...
      noRollbackSetValue(sheet.getRange(newRow, tirelireColumns.date_depot), currentDate);
      
      // Vider les colonnes 'montant', 'recupere' et 'perdu' de la nouvelle ligne
      noRollbackSetValue(sheet.getRange(newRow, tirelireColumns.date_retrait), '');
